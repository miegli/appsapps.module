...
#### Webhook
You can trigger any url by calling webhook method. The triggered Url is receiving full object as serialized data by default.
...
```js
var connector = require("appsapp-cli/connector").init('https://your-project.firebaseio.com/', path.dirname(__filename) + '/serviceAccountKey.json');

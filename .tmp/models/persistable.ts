            ...
            Object.keys(this.__conditionContraintsAffectedProperties[property]).forEach((affectedProperty) => {
                validate(self, {groups: ["condition_" + affectedProperty]}).then((result) => {
                    ...
                    if (result.length) {
                        ...
                        Object.keys(this.__conditionContraintsAffectedProperties[affectedProperty]).forEach((affectedProperty2) => {
                            validate(self, {groups: ["condition_" + affectedProperty2]}).then((result) => {

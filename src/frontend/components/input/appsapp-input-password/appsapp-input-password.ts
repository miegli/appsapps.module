  ...
  selector: 'appsapp-input-password',
    template: `
        ...
        <mat-form-field style="width:100%"
            ...
            <input autocomplete="off" [type]="hide ? 'password' : 'text'" (ngModelChange)="modelChanges($event)" [errorStateMatcher]="errorStateMatcher" [maxlength]="max" [ngModel]="_ngModelGettter | async" matInput [placeholder]="placeholder"  [required]="required">

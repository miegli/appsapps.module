...
export  class AppsappInputAbstractComponent extends AppsappInputComponent {
  ...
  ngOnInit() {
    ...
    this._label = this.label ? this.label : (this.model.getMetadataValue(this.property,'label') ? this.model.getMetadataValue(this.property,'label') : (this._name ? this._name.toUpperCase() : ''));
    this._description = this.model.getMetadataValue(this.property,'description');
